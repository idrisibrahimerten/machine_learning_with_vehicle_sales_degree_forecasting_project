# -*- coding: utf-8 -*-
"""
Created on Fri Mar 18 20:06:27 2022
...
giris_egitim, giris_test, satis_egitim, satis_test = train_test_split(girisler, cikis, test_size = 0.1, random_state=50)
...
print("Model Doğruluk Oranı = ", metrics.accuracy_score(satis_test, satis_tahmin))
